...
- Name: api-management.spec.ts >> API Management Dashboard E2E >> Suite C: API Documentation >> Iframe renders correctly in Documentation Tab
- Location: tests\e2e\api-management.spec.ts:170:9
...
Call log:
  - waiting for getByRole('tab', { name: /Documentation/i })
