...
import PaymentResultFailed from '@/components/payments/PaymentResultFailed';
import PaymentResultProcessing from '@/components/payments/PaymentResultProcessing';
import PaymentResultSuccess from '@/components/payments/PaymentResultSuccess';
